...
const AddNewTrack = () => {
  ...
  return (
    <div className="flex items-center">
      ...
      <div className="gap-2 p-3 border-dashed max-h-24 border-2 border-main rounded-lg justify-center flex-col w-full bg-card-bg flex items-center">
        <span className="text-gray-300">Перетащите файл сюда</span>
        <FiUpload className="w-1/2 h-auto" />
      </div>
    </div>
  );
};
